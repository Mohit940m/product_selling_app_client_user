...
/**
 * Shared auth shell (Kartly Commerce Kit.dc.html screen 01 illustration +
 * the design-system panel, composed for a login/signup split). Left brand
 * panel collapses to a compact header below `lg`.
 */
