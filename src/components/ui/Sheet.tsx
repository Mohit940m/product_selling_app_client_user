...
const Sheet = ({ open, onClose, title, children, panelClassName = '' }: SheetProps) => {
  ...
  return createPortal(
    <div className="fixed inset-0 z-[70] flex items-end justify-end lg:items-stretch">
      <div
        className="absolute inset-0 bg-ink/40 backdrop-blur-sm t-fast"
        onClick={onClose}
        aria-hidden="true"
      />
      <div
        ...
        className={[
          ...
          'lg:h-full lg:max-h-none lg:w-[340px] lg:rounded-none lg:border-l lg:border-line lg:bg-soft2 lg:p-8',
          panelClassName,
        ].join(' ')}
      >
