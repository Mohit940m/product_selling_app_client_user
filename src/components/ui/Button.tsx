...
export type ButtonVariant = 'primary' | 'dark' | 'outline' | 'soft' | 'ghost' | 'pill' | 'icon';
...
const VARIANT_CLASSES: Record<ButtonVariant, string> = {
  primary: 'bg-accent text-onacc font-extrabold lift shadow-none hover:shadow-lift-accent-cta',
